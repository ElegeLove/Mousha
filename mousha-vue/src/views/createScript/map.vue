<template>
    <div class="container container-map">
        ...
        <section class="footer">
            ...
            <div class="footer-button footer-button-nav" @click="back()">
                上一步
            </div>
    ...
    <!-- <div class="map-content-box" style="position:relative">
            <div
              class="mapItem_remove"
              @click="removeMapItem(index)"
            >
            ...
            >
              ...
              >
                <img
                  data-v-200e4a4e=""
                  src="https://miaoxing.oss-cn-beijing.aliyuncs.com/202009/02/565dca2d78b4708fee75232631bc5417.jpg"
                  alt=""
                  style=""
                />
                <vdr
                ...
                >
                  <div class="location_box">
                    ...
                    <div
                      class="location_remove"
                      @click="removeDragOnMapItem(index, dragIndex)"
                    >
                      <img
                        class="location_remove_icon"
                        :src="require('assets/img/map_remove.png')"
...
export default {
    ...
    created() {
        ...
        let data = JSON.parse(window.localStorage.getItem("data")) || null;
        if (data) {
            if (data.map) {
            ...
            this.processData.forEach((item, index) => {
                item["value"] = index;
                if (!data.map) {
                    this.mapList[0].virtualProcessValue.push(index);
                    this.mapList[0].processValue.push(index);
                }
            });
    ...
    methods: {
        ...
        dragstop(x, y) {
            ...
            this.mapList.forEach((mapItem, mapIndex) => {
                if (mapItem.path) {
                    ...
                    // console.log(mapElement.offsetTop, this.scrollTop);
                }
            });
            this.dragY = 0;
            this.dragX = 0;
        ...
        next() {
            ...
            let list = {
                script_node_map_data: [],
                script_map_place_data: []
            };
            let arrs = [];
            this.mapList.forEach((item, index) => {
                list.script_node_map_data[index] = {
                    script_node_keys: item.processValue,
                    script_node_map_name: item.name,
                    attachment: item.imageId
                };
                item.componentList.forEach((locationItem, index2) => {
                    let obj = {
                        script_node_map_key: index,
                        script_place_key: locationItem.clueValue,
            ...
            list.script_map_place_data = arrs;
