    ...
    <div id="clueSetting">
        <div class="clueSetting">
            <div class="clueSetting_top">
                <el-checkbox v-model="checked">搜身</el-checkbox>
            </div>
            <div v-if="checked">
                <div
                    class="clueSetting_item"
                    v-for="(setItem, setI) in personage"
                    :key="setItem.name"
                >
...
export default {
    ...
    created() {
        ...
        if (this.allData.personVal) {
            this.checked = this.allData.personVal.checked;
            this.personage = this.allData.personVal.personList;
        } else {
            if (this.allData.manDrama && this.allData.manDrama.length > 0) {
                // this.personage
                let arr = [];
                this.allData.manDrama.forEach((item, index) => {
                    let obj = {
    ...
    methods: {
        ...
        setUpdate(i, i1) {
            if (i1 == "1") {
                this.setVal = this.personage[i].addressName;
                this.personage[i].status = false;
            } else {
        ...
        setCacel(i, i1) {
            if (i1 == "1") {
                this.personage[i].addressName = this.setVal;
                this.personage[i].status = true;
            } else {
        ...
        setSure(i, i1) {
            if (i1 == "1") {
                if (this.personage[i].addressName == "") {
        ...
        showClueSet(i, i1) {
            ...
            if (i1 == "1") {
                this.procedureNode = this.personage[i].showRole;
                this.isPweson = i1;
            } else {
        ...
        delClues(i, i1,i2) {
            if(i2 == '1'){
                this.personage[i].clueVal.splice(i1, 1);
            }else{
        ...
        clueNameUpdate(i, i1, i2) {
            if (i2 == "1") {
                this.clueNameVal = this.personage[i].clueVal[i1].clueName;
                this.isPweson = i2;
            } else {
        ...
        sureClueName() {
            if (this.isPweson == "1") {
                this.personage[this.addCluesIndex].clueVal[
                    this.cluesValIndex
        ...
        sureAddClue() {
            ...
            if (this.clueName == "") {
                ...
                if (this.clueNameChild == "") {
                    ...
                    if (this.isPweson == "1") {
                        this.personage[this.addCluesIndex].clueVal.push(obj);
                    } else {
                        this.clueSettingVal[this.addCluesIndex].clueVal.push(
                            obj
                        );
                    }
                    this.setShow = false;
        ...
        clickPre() {
            let obj = {
                ...
                personList: this.personage
            };
            this.allData.personVal = obj;
